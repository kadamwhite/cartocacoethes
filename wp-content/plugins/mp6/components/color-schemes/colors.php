...
function mp6_colors_register_schemes() {
	...
	mp6_add_admin_colors( 'mp6-light', array(
		'label' => 'MP6 Light',
		'palette' => array( '#e5e5e5', '#888', '#d64e07', '#04a4cc' ),
		'icon' => array( 'base' => '#666', 'focus' => '#fff', 'current' => '#fff' ),
	) );
...
/*
	...
	wp_admin_css_color(
		'malibu-dreamhouse',
		'Malibu Dreamhouse',
		plugins_url( 'schemes/malibu-dreamhouse/admin-colors.css', __FILE__ ),
	...
	wp_admin_css_color(
		'80s-kid',
		'80\'s Kid',
		plugins_url( 'schemes/80s-kid/admin-colors.css', __FILE__ ),
	...
	wp_admin_css_color(
		'lioness',
		'Lioness',
		plugins_url( 'schemes/lioness/admin-colors.css', __FILE__ ),
